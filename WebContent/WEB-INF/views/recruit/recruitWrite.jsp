...
<script type="text/javascript">
	$j(document).ready(function(){
		...
		var functionalKeys = ['Backspace', 'Delete', 'ArrowLeft', 'ArrowRight', 'ArrowUp', 'ArrowDown', 'Shift', 'Control', 'Alt', 'Meta', 'CapsLock', 'Tab', 'Home', 'End', 'PageUp', 'PageDown'];
		//***********dateFormat을 만드는 함수 **************************
		...
		function checkRecruit(){
			...
			recruit = 
			{
					...
					location : location, workType : workType
			}
		}
		...
		function checkEducation(){
			...
			for(var i =0; i < tableNumbers.length; i ++){
				...
				console.log("startPeriodType: " + typeof startPeriod + " endPeriodType: " + typeof endPeriod 
						+ " schoolNameType: " + typeof schoolName + " division: " + typeof division + " major: " + typeof major 
						+ " grade: " + typeof grade + " location: " + typeof location);
				
				console.log("startPeriod: " +  startPeriod + " endPeriod: " +  endPeriod 
						+ " schoolName: " +  schoolName + " division: " +  division + " major: " +  major 
		...
		function checkCertificate(){
			...
			for(var i =0; i < tableNumbers.length; i ++){
				...
				if(i !== 0 && qualifiName === "" && acquDate === "" && organizeName === ""){
					continue;
				}
